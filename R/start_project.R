# -----------------------------------------------------------------------------
# This function creates the directories for the project, and creates a file to
# store the Coordinate Reference System (CRS) fot the project.
start_project <-
  function() {
    ...
    fs::dir_create("./data/results/")

    # Write text file to store Coordinate Reference System (CRS)
    readr::write_file(
      x = glue::glue(
